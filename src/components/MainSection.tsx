...
export default function MainSection() {
  ...
  return (
    <section
      className={`flex flex-col-reverse md:flex-row items-center justify-center min-h-screen w-full p-6 sm:px-12 md:px-20 ${fontPoppins.className} relative gap-10 md:gap-0`}
    >
